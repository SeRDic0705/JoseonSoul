...
0. **구현 착수 전 사전 허가 필수.** 계획을 세운 뒤 Discord로 보고하고, 마스터의 명시적 허가 문구("진행해"/"구현해"/"허가")를 받은 뒤에만 코드/MCP/커밋/푸시/PR을 시작한다. "계획 진행하자"처럼 목적어가 계획/설계 논의인 문장은 구현 착수 허가가 아니다 — 애매하면 "구현 착수해도 될까요?"로 한 번 더 확인.
